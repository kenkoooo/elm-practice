...
var author$project$Components$Navbar$initialState = function (toMsg) {
	return rundis$elm_bootstrap$Bootstrap$Navbar$initialState(toMsg);
};
var author$project$Types$NavbarMsg = function (a) {
	return {$: 'NavbarMsg', a: a};
};
var author$project$Main$init = function (_n0) {
	var _n1 = author$project$Components$Navbar$initialState(author$project$Types$NavbarMsg);
	var navbarState = _n1.a;
	var navbarCmd = _n1.b;
	return _Utils_Tuple2(
		{atcoderProblems: _List_Nil, errMsg: elm$core$Maybe$Nothing, input: '', navbarState: navbarState, problems: _List_Nil},
		navbarCmd);
};
...
var author$project$Components$Navbar$subscriptions = rundis$elm_bootstrap$Bootstrap$Navbar$subscriptions;
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Main$onStoreChange = _Platform_incomingPort('onStoreChange', elm$json$Json$Decode$string);
var author$project$Types$ReceiveLocalStorage = function (a) {
	return {$: 'ReceiveLocalStorage', a: a};
};
var author$project$Main$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A2(author$project$Components$Navbar$subscriptions, model.navbarState, author$project$Types$NavbarMsg),
				author$project$Main$onStoreChange(author$project$Types$ReceiveLocalStorage)
			]));
};
var author$project$Types$Other = function (a) {
	return {$: 'Other', a: a};
};
var author$project$Types$Aizu = function (a) {
	return {$: 'Aizu', a: a};
};
var author$project$Types$AtCoder = F2(
	function (a, b) {
		return {$: 'AtCoder', a: a, b: b};
	});
...
var author$project$UrlParser$problemParser = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2(
			elm$url$Url$Parser$map,
			author$project$Types$AtCoder,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s('contests'),
				A2(
					elm$url$Url$Parser$slash,
			...
			A2(
			elm$url$Url$Parser$map,
			author$project$Types$Aizu,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s('onlinejudge'),
				A2(
					elm$url$Url$Parser$questionMark,
					elm$url$Url$Parser$s('description.jsp'),
...
var author$project$UrlParser$parseUrl = function (url) {
	return A2(
		elm$core$Maybe$map,
		function (u) {
			return A2(
				elm$core$Maybe$withDefault,
				author$project$Types$Other(url),
				A2(elm$url$Url$Parser$parse, author$project$UrlParser$problemParser, u));
		},
		elm$url$Url$fromString(url));
};
var author$project$Main$createCard = function (url) {
	return A2(
		elm$core$Maybe$map,
		function (parsedProblem) {
			return {lastSolvedTime: 0, parsedProblem: parsedProblem, remindTime: 0, title: url, url: url};
		},
		author$project$UrlParser$parseUrl(url));
};
var elm$json$Json$Encode$string = _Json_wrap;
var author$project$Main$storeCache = _Platform_outgoingPort('storeCache', elm$json$Json$Encode$string);
...
var author$project$Main$updateProblemCardInfo = F2(
	function (model, info) {
		var _n0 = info.parsedProblem;
		if (_n0.$ === 'AtCoder') {
			var problemId = _n0.b;
			var x = elm$core$List$head(
				A2(
					elm$core$List$filter,
					function (problem) {
						return _Utils_eq(problem.id, problemId);
					},
					model.atcoderProblems));
			if (x.$ === 'Just') {
				var p = x.a;
				return _Utils_update(
					info,
...
var author$project$Services$AtCoder$handleJsonResponse = F2(
...
var author$project$Types$AtCoderProblem = F3(
	function (id, contestId, title) {
		return {contestId: contestId, id: id, title: title};
	});
var elm$json$Json$Decode$map3 = _Json_map3;
var author$project$Services$AtCoder$problemDecoder = A4(
	elm$json$Json$Decode$map3,
	author$project$Types$AtCoderProblem,
	A2(elm$json$Json$Decode$field, 'id', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'contest_id', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'title', elm$json$Json$Decode$string));
var author$project$Services$AtCoder$problemUrl = 'https://kenkoooo.com/atcoder/resources/problems.json';
var author$project$Types$HttpError = function (a) {
...
var author$project$Services$AtCoder$getProblems = A2(
	elm$core$Task$mapError,
	author$project$Types$HttpError,
	elm$http$Http$task(
		{
			...
			resolver: elm$http$Http$stringResolver(
				author$project$Services$AtCoder$handleJsonResponse(
					elm$json$Json$Decode$list(author$project$Services$AtCoder$problemDecoder))),
			timeout: elm$core$Maybe$Nothing,
			url: author$project$Services$AtCoder$problemUrl
		}));
var author$project$Types$GotAtCoderProblems = function (a) {
	return {$: 'GotAtCoderProblems', a: a};
};
		...
		switch (msg.$) {
			...
			case 'Input':
				...
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			case 'Submit':
				var _n1 = author$project$Main$createCard(model.input);
				if (_n1.$ === 'Just') {
					var newCard = _n1.a;
					var newCmd = function () {
						var _n2 = newCard.parsedProblem;
						if (_n2.$ === 'AtCoder') {
							return elm$core$List$isEmpty(model.atcoderProblems) ? A2(elm$core$Task$attempt, author$project$Types$GotAtCoderProblems, author$project$Services$AtCoder$getProblems) : elm$core$Platform$Cmd$none;
						} else {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								problems: A2(
									elm$core$List$map,
									author$project$Main$updateProblemCardInfo(model),
									A2(elm$core$List$cons, newCard, model.problems))
							}),
						elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									newCmd,
									author$project$Main$storeCache('a')
								])));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'GotAtCoderProblems':
				var result = msg.a;
				if (result.$ === 'Err') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								errMsg: elm$core$Maybe$Just('Failed fetching the problem list of AtCoder')
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var problems = result.a;
					var updatedModel = _Utils_update(
						model,
						{atcoderProblems: problems});
					return _Utils_Tuple2(
						_Utils_update(
							updatedModel,
							{
								problems: A2(
									elm$core$List$map,
									author$project$Main$updateProblemCardInfo(updatedModel),
									updatedModel.problems)
							}),
						elm$core$Platform$Cmd$none);
				}
			default:
...
var author$project$Components$Navbar$view = function (model) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					...
					A2(rundis$elm_bootstrap$Bootstrap$Navbar$itemLink, _List_Nil, _List_Nil),
			...
			A3(
				...
				rundis$elm_bootstrap$Bootstrap$Navbar$withAnimation(
					rundis$elm_bootstrap$Bootstrap$Navbar$config(author$project$Types$NavbarMsg)))));
};
...
var author$project$Components$ProblemCard$view = function (info) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				author$project$Components$Navbar$view(model),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Events$onSubmit(author$project$Types$Submit)
									]),
								_List_fromArray(
									[
										A2(
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																elm$html$Html$Attributes$placeholder('aaa'),
				...
				_List_fromArray(
					[
						...
						A2(
							elm$core$List$map,
							function (info) {
								return author$project$Components$ProblemCard$view(info);
							},
							model.problems))
					]))
			]));
